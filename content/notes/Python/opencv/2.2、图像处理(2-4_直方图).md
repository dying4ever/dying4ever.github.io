...
![](2.2、图像处理(2-4 直方图).assets/image-20240127145908.png)

注意：直方图是根据灰度图进行绘制的，而不是彩色图像。   假设有一张图像的信息（灰度值 0 - 255，已知数字的范围包含 256 个值，于是可以按一定规律将这个范围分割成子区域（也就是 bins）。如：

![](2.2、图像处理(2-4 直方图).assets/image-20240127145934.png)
...
![](2.2、图像处理(2-4 直方图).assets/image-20240127150034.png)
...
![](2.2、图像处理(2-4 直方图).assets/image-20240127150837.png)
...
![](2.2、图像处理(2-4 直方图).assets/image-20240127151541.png)
...
![](2.2、图像处理(2-4 直方图).assets/image-20240127151627.png)
...
![](2.2、图像处理(2-4 直方图).assets/image-20240127151718.png)
...
![](2.2、图像处理(2-4 直方图).assets/image-20240127151733.png)
...
![](2.2、图像处理(2-4 直方图).assets/image-20240127151749.png)
